...
public class testWS {
    ...
    public int registrarProducto(String json){
        try {
            ...
            String nombreImagen = util.decodeimage(producto.getImagen(), null); // imageBase64
    ...
    public int actualizarProducto(String json){
        try {
            ...
            // decodificar cadena base64 a imagen
            Utilidades util = new Utilidades();
            String nombreImagen = util.decodeimage(producto.getImagen(), producto.getCodigo());
   
            int resultado = new ProductoService().actualizarProducto(producto.getCodigo(), producto.getDescripcion(), producto.getDetalle(), producto.getStock(), producto.getPrecio(), nombreImagen);
    ...
    public int eliminarProducto(String json){
        try {
            ...
            // tabién borramos la imagen
            if (resultado == 1){
                File fichero = new File("E:\\image" + producto.getCodigo() + ".jpg");
                if (fichero.delete())
